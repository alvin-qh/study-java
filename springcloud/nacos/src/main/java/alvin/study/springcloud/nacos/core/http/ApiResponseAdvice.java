...
@Slf4j
@Component
@RestControllerAdvice(basePackages = "alvin.study.springcloud.nacos.endpoint") // 限定 Controller 的范围
public class ApiResponseAdvice implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(
        ...
        var retType = Objects.requireNonNull(returnType.getMethod()).getReturnType();
     ...
     * @return 字符串结果
     */
    private @NotNull String pathToPropertyName(@NotNull Path path) {

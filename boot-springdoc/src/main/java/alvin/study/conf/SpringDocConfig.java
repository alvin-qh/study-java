...
public class SpringDocConfig {
     ...
     */
    @Bean
    GroupedOpenApi groupedOpenApiForAuth(@Qualifier("openApiCustomiser") OpenApiCustomiser customiser) {
        return GroupedOpenApi.builder()
                ...
                .pathsToMatch("/auth/**")
                // 设置分组内容的个性化处理对象
                .addOpenApiCustomiser(customiser)
                .build();
    }
     ...
     */
    @Bean
    GroupedOpenApi groupedOpenApiForApi(@Qualifier("openApiCustomiser") OpenApiCustomiser customiser) {
        return GroupedOpenApi.builder()
                // 设置分组名称
                .group("API")
                // 设置分组对应的 URL 路径

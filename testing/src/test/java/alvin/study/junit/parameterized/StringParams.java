...
/**
 * 为
 * {@link alvin.study.junit.ParameterizeTest#shouldReturnTrueForNullOrBlankStringsByClassMethod(String)
 * ParameterizeTest.shouldReturnTrueForNullOrBlankStringsByClassMethod(String)}
 * 测试方法提供测试参数的类型
 */

...
class MockObjectTest {
     ...
     *
     * <p>
     * {@link org.mockito.Mockito#when(Object) Mockito.when(Object)} 表示要仿冒的方法, 返回一个
     * {@link org.mockito.stubbing.OngoingStubbing OngoingStubbing} 对象, 表示仿冒方法调用的存根
     * </p>
     *
     * <p>
     * {@link org.mockito.stubbing.OngoingStubbing#thenReturn(Object) OngoingStubbing.thenReturn(Object)} 表示仿冒方法
     * 的返回值
     * </p>
     *
     * <p>
     * 为仿冒方法指定确定的参数值后, 在调用该仿冒方法时, 如果传递的参数和预设一致, 则调用成功, 返回预设的返回值
     * </p>
     *
     * <p>
     * 在仿冒方法调用时, 如果指定了确认的参数, 则在调用该函数时也期待传递相同参数, 否则会引发 {@link PotentialStubbingProblem} 异常
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link org.mockito.ArgumentMatchers#anyString() ArgumentMatchers.anyString()} 方法表示仿冒对象的参数表示"任意字符串"
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link org.mockito.ArgumentMatchers#any() ArgumentMatchers.any()} 方法表示仿冒对象的参数表示"任意对象"
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link org.mockito.ArgumentMatchers#any(Class) ArgumentMatchers.any(Class)} 方法表示仿冒对象的参数表示
     * "任意指定类型对象"
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link org.mockito.stubbing.OngoingStubbing#thenThrow(Class) OngoingStubbing.thenThrow(Class)} 指定在调用仿冒方法
     * 时抛出指定异常
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link org.mockito.stubbing.OngoingStubbing#thenAnswer(org.mockito.stubbing.Answer)
     * OngoingStubbing.thenAnswer(Answer)} 指定一个函数对象, 该对象将取代被仿冒方法来执行
     * </p>
     */
    @Test

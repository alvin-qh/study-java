 ...
 *
 * <p>
 * {@link org.junit.jupiter.api.Assumptions Assumptions}
 * 类中的方法用来跳过测试, 即在指定条件满足的情况下, 达到和
 * {@link org.junit.jupiter.api.Disabled @Disabled} 注解达到类似的效果
 * </p>
 *
 * <p>
...
class AssumptionsTest {
     ...
     * Assumptions.assumeTrue(BooleanSupplier)} 方法可以在所给参数表达为
     * {@code false} 时跳出当前测试
     */
    @Test
    @DisplayName("😱")
     ...
     * {@link org.junit.jupiter.api.Assumptions#assumeFalse(
     * java.util.function.BooleanSupplier)
     * Assumptions.assumeFalse(BooleanSupplier)} 方法可以在所给参数表达为
     * {@code true} 时跳出当前测试
     */
    @Test
    ...
    /**
     * {@link org.junit.jupiter.api.Assumptions#assumingThat(boolean,
     * org.junit.jupiter.api.function.Executable)
     * Assumptions.assumingThat(boolean, Executable)} 和
     * {@link org.junit.jupiter.api.Assumptions#assumingThat(
     * java.util.function.BooleanSupplier, org.junit.jupiter.api.function.Executable)
     * assumingThat(BooleanSupplier, Executable)} 方法可以在前一个参数表达为
     * {@code true} 时, 执行后一个参数传入的 lambda 表达式
     */
    @Test

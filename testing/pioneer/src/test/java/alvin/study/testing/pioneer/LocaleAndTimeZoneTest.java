...
class LocaleAndTimeZoneTest {
     ...
     *
     * <p>
     * 通过 {@link DefaultLocale @DefaultLocale} 注解可以为测试方法指定默认的国际化标识, 即修改 {@link Locale#getDefault()} 方法
     * 的返回值
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * 相当于通过 {@link Locale.Builder#setRegion(String)}, {@link Locale.Builder#setLanguage(String)} 以及
     * {@link Locale.Builder#setVariant(String)} 方法进行设置, 并通过 {@link Locale.Builder#build()} 方法得到的
     * {@link Locale} 对象
     * </p>
     */
    @Test

...
class EmployeeRepositoryTest extends IntegrationTest {
     ...
     *
     * <p>
     * 该方法的语义是获取所有的 {@link alvin.study.infra.entity.Employee Employee} 实体对象,
    ...
    /**
     * 测试 {@link EmployeeRepository#findEmployeeByDepartment(Department)} 方法, 该方法通过
     * JPQL 完成查询
     *
     * <p>
     * 该方法由 {@link alvin.study.infra.repository.ext.EmployeeRepositoryExt
     * EmployeeExtensionRepository} 接口引入, 且该接口被
     * {@link alvin.study.infra.repository.ext.EmployeeRepositoryExt.EmployeeRepositoryExtImpl

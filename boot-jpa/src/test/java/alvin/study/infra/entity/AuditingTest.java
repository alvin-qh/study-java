 ...
 * 测试实体类型的审计字段是否生效
 *
 * @see alvin.study.infra.entity.common.AuditedEntity
...
class AuditingTest extends IntegrationTest {
     ...
     *
     * <p>
     * 在超类 {@link alvin.study.IntegrationTest#beforeEach IntegrationTest.beforeEach}
     * 方法中, 为当前请求上下文注册了 {@link alvin.study.common.Context Context} 对象,
     * 并在对象中注册了 {@link User} 和 {@link Org} 两个对象, 表示当前登录的用户和其所在的组织 (租户)
     * </p>
     *
     * @see alvin.study.common.Context
     * @see alvin.study.core.context.CustomRequestAttributes#register(Context)
     */
    @Test
     ...
     *
     * <p>
     * 在超类 {@link alvin.study.infra.entity.common.AuditedEntity AuditedEntity} 实体类中,
     ...
     * <p>
     * 按照
     * {@link alvin.study.infra.entity.common.TenantedEntityListener#touchForCreate(Object)

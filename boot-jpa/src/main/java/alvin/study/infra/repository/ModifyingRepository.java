...
public interface ModifyingRepository extends CrudRepository<User, Long> {
    /**
     * 通过 {@link User#account} 字段查询 {@link User} 对象的集合
     *
     * <p>
     ...
     * </p>
     *
     * @param account {@link User#account} 字段值
    ...
    /**
     * 通过匹配 {@link User#id} 字段的值, 来更新对应对象的 {@link User#password} 字段
     *
     * <p>
     ...
     * </p>
     *
     * @param id       {@link User#id} 的值
     * @param password 要更新的 {@link User#password} 字段值
     */
    ...
    /**
     * 通过匹配 {@link User#account} 字段的值来删除对应的 {@link User} 实体对象
     *
     * <p>
     ...
     * </p>
     *
     * @param account {@link User#account} 的值
     */

...
import alvin.study.builder.GroupBuilder;
import alvin.study.builder.PermissionBuilder;
import alvin.study.builder.RoleBuilder;
import alvin.study.builder.RoleGrantBuilder;
import alvin.study.builder.RolePermissionBuilder;
import alvin.study.builder.UserBuilder;
import alvin.study.builder.UserGroupBuilder;
import alvin.study.common.TableCleaner;
import alvin.study.common.TestingTransaction;
import alvin.study.common.TestingTransactionManager;
import alvin.study.conf.TestingConfig;
import alvin.study.conf.TestingContextInitializer;
...
import alvin.study.infra.entity.RoleGrantType;
import alvin.study.infra.entity.User;
import alvin.study.infra.entity.UserType;
import alvin.study.infra.mapper.PermissionMapper;
import alvin.study.infra.mapper.RoleGrantMapper;
import alvin.study.infra.mapper.RoleMapper;
import alvin.study.infra.mapper.RolePermissionMapper;
...
public abstract class IntegrationTest {
     ...
     * </p>
     *
     * @see alvin.study.conf.TestingConfig#testingTransactionManager(org.springframework.transaction.PlatformTransactionManager)
     ...
     * 注入 Jwt 对象
     *
     * @see alvin.study.conf.BeanConfig#jwt() BeanConfig.jwt()
     */
    @Autowired
    private Jwt jwt;

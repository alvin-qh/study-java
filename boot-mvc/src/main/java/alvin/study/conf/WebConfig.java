...
import alvin.study.core.http.PathsHandlerInterceptor;
...
public class WebConfig implements WebMvcConfigurer, WebServerFactoryCustomizer<ConfigurableServletWebServerFactory> {
     ...
     * <ul>
     * <li>
     * {@link PathsHandlerInterceptor} 拦截器, 由 {@link WebConfig#interceptors} 集合字段注入,
     * 在 {@link WebConfig#addInterceptors(InterceptorRegistry)} 方法中进行注册. 这类拦截器带有

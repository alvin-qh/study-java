package alvin.study.infra.mapper;
...
class UserMapperTest extends IntegrationTest {
    ...
    /**
     * 测试 {@link UserMapper#insert(alvin.study.infra.entity.User)
     * UserMapper.insert(User)} 方法
     *
     * <p>
     * {@link UserMapper#insert(alvin.study.infra.entity.User)
     * UserMapper.insert(User)} 方法继承自
    ...
    /**
     * 测试 {@link UserMapper#updateById(alvin.study.infra.entity.User)
     * UserMapper.updateById(User)} 方法
     *
     * <p>
     * {@link UserMapper#updateById(alvin.study.infra.entity.User)
     * UserMapper.updateById(User)} 方法继承自
     * {@link com.baomidou.mybatisplus.core.mapper.BaseMapper BaseMapper} 超类
     * </p>
     *
     * <p>
    ...
    /**
     * 测试 {@link UserMapper#deleteById(alvin.study.infra.entity.User)
     * UserMapper.deleteById(User)} 方法
     *
     * <p>
     * {@link UserMapper#deleteById(alvin.study.infra.entity.User)
     * UserMapper.deleteById(User)} 方法继承自
     * {@link com.baomidou.mybatisplus.core.mapper.BaseMapper BaseMapper} 超类
     * </p>
     *
     * <p>
     ...
     * <li>
     * 定义通用方法, 参考
     * {@link alvin.study.infra.mapper.method.DeleteAllMethod DeleteAllMethod} 类型
     * </li>
     * <li>
     * 注入通用方法, 参考
     * {@link alvin.study.conf.MyBatisConfig#getMethodList(Class, com.baomidou.mybatisplus.core.metadata.TableInfo)
     ...
     * <li>
     * 定义通用方法, 参考
     * {@link alvin.study.infra.mapper.method.InsertAllBatchMethod

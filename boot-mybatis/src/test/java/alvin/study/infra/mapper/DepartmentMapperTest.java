...
class DepartmentMapperTest extends IntegrationTest {
    ...
    /**
     * 测试
     * {@link DepartmentMapper#selectByEmployee(alvin.study.infra.entity.Employee)
     ...
     * 对象转为 {@link Department} 对象, 参考
     * {@link alvin.study.conf.ModelMapperConfig#modelMapper()
     * ModelMapperConfig.modelMapper()} 方法中对于 {@code ModelMapper} 对象的设置
     * </p>
     */
    @Test
    @Transactional

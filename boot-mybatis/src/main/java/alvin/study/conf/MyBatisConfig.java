...
import alvin.study.infra.mapper.method.DeleteAllMethod;
import alvin.study.infra.mapper.method.InsertAllBatchMethod;
...
@MapperScan(basePackages = { "alvin.study.infra.mapper" })
...
public class MyBatisConfig extends DefaultSqlInjector {
     ...
     *
     * <p>
     * 注入的方法需要在所有 Mapper 类型的超类中定义, 参考 {@link alvin.study.infra.mapper.BaseMapper
     * BaseMapper} 中定义的通用方法
     * </p>
     *
     * @see DeleteAllMethod

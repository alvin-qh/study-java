 ...
 * {@link alvin.study.infra.handler.EntityFieldHandler EntityFieldHandler}
 * 类型的定义, 该类型会对于所有继承自 {@link alvin.study.infra.entity.common.AuditedEntity
 * AuditedEntity} 或 {@link alvin.study.infra.entity.common.TenantedEntity
...
public interface DepartmentMapper extends BaseMapper<Department> {
     ...
     * {@link alvin.study.infra.handler.TimestampTypeHandler TimestampTypeHandler}
     * 以及其配置方法 {@link alvin.study.conf.MyBatisConfig#propertiesCustomizer()
     ...
     * {@link alvin.study.conf.ModelMapperConfig#modelMapper()
    ...
    default List<Map<String, Object>> selectByEmployee(Employee employee) {
        ...
        return SqlRunner.db(Department.class).selectList(sql.toString(), employee.getId());
    }
}

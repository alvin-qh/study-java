 ...
 * <li>
 * 声明通用方法, 参考
 * {@link alvin.study.infra.mapper.BaseMapper#insertAllBatch(java.util.List)
 * BaseMapper.insertAllBatch(List)} 方法
 * </li>
 * </ol>
 * </p>
 */
public class InsertAllBatchMethod extends AbstractMethod {
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        // 产生 SQL 模板
        sql = String.format(sql, tableInfo.getTableName(), fieldSql.toString(), valueSql.toString());

package alvin.study.infra.mapper.method;
 ...
 * </li>
 * <li>
 * 声明通用方法, 参考 {@link alvin.study.infra.mapper.BaseMapper#deleteAll()
...
public class DeleteAllMethod extends AbstractMethod {
    /**
     * 方法名, 必须和 {@link alvin.study.infra.mapper.BaseMapper BaseMapper} 中添加的方法同名
     *
     * @see alvin.study.infra.mapper.BaseMapper#deleteAll() BaseMapper.deleteAll()
     */
    private static final String METHOD_ID = "deleteAll";

    /**
     * 构造器, 传入方法名称, {@link AbstractMethod#AbstractMethod()} 构造器已经过期, 需要调用
     * {@link AbstractMethod#AbstractMethod(String)} 构造器
     */
     ...
     * </p>
     *
     * @param mapperClass 所有从 {@link alvin.study.infra.mapper.BaseMapper BaseMapper}
     *                    继承的的 Mapper 类型

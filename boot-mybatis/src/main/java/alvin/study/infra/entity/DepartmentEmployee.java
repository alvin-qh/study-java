...
public class DepartmentEmployee extends AuditedEntity {
     ...
     *
     * <p>
     * 其次, 需要通过 {@link Version @Version} 注解在实体类中注解对应的 {@link #version} 字段
     * </p>
     *
     * <p>
     * 最后, 需要开启 MyBatis 的 Interceptor, 参考:
     * {@link alvin.study.conf.MyBatisConfig#interceptor()
     * MyBatisConfig.interceptor()} 方法
     * </p>
     */
    @Version
    @TableField("version")

 ...
 *
 * <p>
 * {@link Verify} 类型的 {@code verify} 方法可以对一个条件表达式进行检验,
 * 如果表达式为 {@code true} 表示通过检验, 如果为 {@code false} 则抛出
 * {@link VerifyException} 异常
 * </p>
 */
class VerifyTest {
    /**
     ...
     *
     * <p>
     * {@link Verify#verify(boolean, String, Object...)} 方法的第一个参数为条件表达式,
     * 后续参数为一个错误信息模板以及模板参数. 如果所给的条件表达式为 {@code false},
     * 则抛出 {@link VerifyException} 异常, 并携带所给的错误信息
     * </p>
     *
     * <p>
    ...
    void verify_shouldVerifyByConditionsAtRuntime() {
        ...
        thenThrownBy(() -> Verify.verify(a > 10))

...
public class UserHandler extends AbstractHandler {
     ...
     * {@link EventBusManager#registerAsyncEventBus(String)} 方法创建 {@code EventBus}
     * 对象
     * </p>
     *
     ...
     *
     * <p>
     * 所有通过 {@link EventBus#post(Object)} 方法, 且参数为 {@link UserEvent} 类型对象的调用,
     * 都会执行到此方法中,
     * 从而完成了该方法和其它方法的解耦, 参考
     * {@link alvin.study.eventbus.repository.UserRepository#insertUser(User)
     ...
     *
     * <p>
     * 对于异步方式创建的 {@link EventBus} 对象, 且 {@link #asAsync} 字段为 {@code true} 时, 本方法会模拟
     * IO 阻塞约 2 秒,
     * 以体现异步消息处理的特征
     * </p>
     *

 ...
 *
 * <p>
 * 网络类型 {@link com.google.common.graph.Network Network} 是一种特殊类型的"图",
 * 该类型允许两个节点之间存在多条"边", 每条边均有一个"唯一对象"表示
 * </p>
 *
 * <p>
...
class TestNetwork {
    ...
    class TestDirectedNetwork {
         ...
         *
         * <p>
         * 通过 {@link com.google.common.graph.Network#nodes() Network.nodes()}
         * 方法可以获取网络中的所有节点对象集合
         * </p>
         *
         * <p>
         * 通过 {@link com.google.common.graph.Network#edges() Network.edges()}
         * 方法可以获取网络中所有边对象集合
         * </p>
         */
        @Test
        void build_shouldBuildDirectedNetwork() {
            // 构建有向网络
            var network = datasource.buildNetwork(
         ...
         *
         * <p>
         * 通过 {@link com.google.common.graph.Network#adjacentEdges(Object)
         * Network.adjacentEdges(E)} 方法可以获取网络中指定边的邻接边对象集合
         * </p>
         *
         * <p>
         * 所谓 "邻接边", 即和指定边两个节点任意一个重合的其它边, 例如: 节点 {@code 2, 3}
         * 组成的边 {@code 2-3}, 其 "邻接边" 可能为 {@code 1-2, 2-4, 2-5, 3-8, 3-6} 等
         * </p>
         */
        @Test
         ...
         *
         * <p>
         * 通过 {@link com.google.common.graph.Network#edgeConnecting(Object, Object)
         * Network.edgeConnecting(N, N)} 方法可以获取网络中两个节点之间的边对象
         * </p>
         */
        @Test
         ...
         *
         * <p>
         * 所谓"唯一边对象", 即作为参数的两个节点间只能有一个"边对象", 如果有多个平行边对象,
         * 则调用该方法会抛出异常
         * </p>
         */
        @Test
         ...
         *
         * <p>
         * 通过 {@link com.google.common.graph.Network#incidentEdges(Object)
         * Network.incidentEdges(N)} 方法可以获取网络中和指定节点相关的"邻接边"对象集合
         * </p>
         *
         * <p>
         ...
         *
         * <p>
         * 通过 {@link com.google.common.graph.Network#incidentNodes(Object)
         * Network.incidentNodes(E)} 方法可以根据所给的边对象, 获取该边的两个连接节点
         * </p>
         */
        @Test
    ...
    class TestUndirectedNetwork {
        ...
        void edgeConnectingOrNull_shouldGetSingleConnectingEdgeBetweenTwoNodesInUndirectedNetwork() {
            ...
            // 在两个节点间增加新的边对象, 确认再次获取边对象会抛出异常
            network.addEdge(2, 3, "2-3a");
            thenThrownBy(() -> network.edgeConnectingOrNull(2, 3))

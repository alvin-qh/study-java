...
class IterableUtilsTest {
     ...
     *
     * <p>
     * {@link Iterables#addAll(java.util.Collection, Iterable)
     * Iterables.addAll(Collection, Iterable)}
     * 方法用于将一个可迭代对象包含的元素添加到另一个集合中
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#all(Iterable, com.google.common.base.Predicate)
     * Iterables.all(Iterable, Predicate)}
     * 方法用于判断一个可迭代对象包含的所有元素均符合指定条件
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#any(Iterable, com.google.common.base.Predicate)
     * Iterables.any(Iterable, Predicate)}
     * 方法用于判断可迭代对象中至少有一个元素符合指定条件
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#concat(Iterable...) Iterables.concat(Iterable...)}
     * 方法将多个可迭代对象合并成一个, 从而可以通过一次迭代, 遍历多个可迭代对象的内容
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#consumingIterable(Iterable)
     * Iterables.consumingIterable(Iterable)} 方法用于包装一个可迭代对象, 得到的
     * 代理对象 ({@link com.google.common.collect.FluentIterable FluentIterable} 类型)
     * 在迭代过程中会删除对应集合中的元素, 在迭代完毕后, 对应集合会被清空
     * </p>
     *
     * <p>
     * 注意, 被包装的可迭代对象, 其迭代器属性必须支持 {@link java.util.Iterator#remove()
    ...
    void consumingIterable_shouldReadAndRemoveElementsByIterable() {
...

        {
            ...
            thenThrownBy(() -> Iterables.getFirst(iterable, null))
     ...
     *
     * <p>
     * {@link Iterables#contains(Iterable, Object) Iterables.contains(Iterable, Object)}
     * 方法用于从一个迭代器中确认是否包含指定的元素值
     * </p>
     */
    @Test
     ...
     * Iterables.filter(Iterable, Predicate)} 方法返回一个可迭代对象,
     * 只包含所给可迭代对象中符合条件的元素值
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#frequency(Iterable, Object)
     * Iterables.frequency(Iterable, Object)}
     * 方法用于将一个可迭代对象中包含的元素逐一和目标对象进行比较,
     * 并统计和目标对象相等的元素个数
     * </p>
     */
    @Test
     ...
     * Iterables.find(Iterable, Predicate, Object)} 方法遍历可迭代对象,
     * 并找到第一个符合条件的元素, 如果可迭代对象中不包含符合条件的元素,
     * 则返回所给的默认值
     * </p>
     *
     * <p>
     * {@link Iterables#tryFind(Iterable, com.google.common.base.Predicate)
     * Iterables.tryFind(Iterable, Predicate)} 和 {@code find} 方法类似,
     * 返回一个 {@link com.google.common.base.Optional Optional}
     ...
     *
     * <p>
     * {@link Iterables#partition(Iterable, int) Iterables.partition(Iterable, int)}
     * 方法遍历可迭代对象, 并将得到的元素按顺序存入到另外的指定数量的集合中.
     * 例如: 将集合 {@code [1, 2, 3]} 分到两个数组中, 结果为 {@code [[1, 2], [3]]}
     * </p>
     *
     * <p>
     * {@link Iterables#paddedPartition(Iterable, int)
     * Iterables.paddedPartition(Iterable, int)} 方法与 {@link Iterables#partition(Iterable, int)
     * Iterables.partition(Iterable, int)} 方法基本类似, 但要求结果中每个数组的元素个数都是一致的,
     * 如果元素数量不足, 则以 {@code null} 填充. 例如: 将集合 {@code [1, 2, 3]} 分到两个数组中, 结果为
     * {@code [[1, 2], [3, null]]}
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#getFirst(Iterable, Object) Iterables.getFirst(Iterable, Object)}
     * 方法获取可迭代对象的第一个元素值, 如果迭可迭代对象为空, 则返回默认值
     * </p>
     *
     * <p>
     * {@link Iterables#getLast(Iterable, Object) Iterables.getLast(Iterable, Object)}
     * 方法获取可迭代对象的最后一个元素, 如果可迭代对象为空, 则返回所给的默认值
     * </p>
     *
     * <p>
     * {@link Iterables#get(Iterable, int, Object) Iterables.get(Iterable, int, Object)}
     * 方法获取迭代指定次数后的元素值, 如果迭代器在指定次数前已经迭代完毕, 则返回所给的默认值
     * </p>
     *
     * <p>
     * {@link Iterables#getOnlyElement(Iterable, Object)
     * Iterables.getOnlyElement(Iterable, Object)} 方法获取可迭代对象中唯一的元素,
     * 即可迭代对象只包含一个元素时, 返回该元素值; 如果不包含元素, 则返回默认值;
     * 如果包含多个元素, 则抛出异常
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#indexOf(Iterable, com.google.common.base.Predicate)
     * Iterables.indexOf(Iterable, Predicate)} 方法遍历迭代器, 并找到第一个符合条件的元素并返回其索引,
     * 如果迭代器中不包含符合条件的元素, 则返回 {@code -1}
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#transform(Iterable, com.google.common.base.Function)
     * Iterables.transform(Iterable, Function)} 方法包装一个可迭代对象,
     * 返回的可迭代对象, 新对象在迭代过程中可以将原对象得到的元素进行转换后返回
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#skip(Iterable, int)} 方法将一个可迭代对象跳过指定位置,
     * 返回一个新的可迭代对象, 从跳过位置之后作为起始的迭代位置
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#limit(Iterable, int) Iterables.limit(Iterable, int)}
     * 方法包装一个可迭代对象, 返回新的可迭代对象, 且返回的新可迭代对象允许被迭代的次数被限制在指定次数内
     * </p>
     */
    @Test
     ...
     *
     * <p>
     * {@link Iterables#mergeSorted(Iterable, java.util.Comparator)
     * Iterables.limit(Iterable, Comparator)} 方法对多个可迭代对象的内容进行归并排序,
     * 得到一个存储归并结果且内容有序的可迭代对象
     * </p>
     *
     * <p>
     * 注意: {@code mergeSorted} 方法本身不对输入的可迭代对象排序,
     * 所以要保证输入的每个可迭代对象内部元素有序, 且排序规则要和后面进行归并排序的规则保持一致
     * </p>
     */
    @Test
     ...
     * 用于判断两个可迭代对象包含的元素完全相等, 即: 数量一致, 且对应位置的元素相等
     * </p>
     */
    @Test

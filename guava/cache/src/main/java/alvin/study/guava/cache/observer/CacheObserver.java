 ...
 *
 * <p>
 * {@link #onUserUpdated(UserUpdateEvent)} 方法用于监听
 * {@link UserUpdateEvent} 类型事件, 完成 {@link User}
 * 实体被更新后的缓存处理工作
 * </p>
 *
 * <p>
 * {@link #onUserDeleted(UserDeleteEvent)} 方法用于监听
 * {@link UserDeleteEvent} 类型事件, 完成 {@link User}
 * 实体被删除后的缓存处理工作
 * </p>
 */
public class CacheObserver {
     ...
     *
     * <p>
     * {@link User} 实体对象更新后, 如果缓存中存在对应的缓存项,
     * 则对其进行刷新
     * </p>
     *
     * @param event {@link UserUpdateEvent} 事件对象, 表示一个
     *              {@link User} 实体被更新
     */
    @Subscribe
     ...
     * </p>
     *
     * @param event {@link UserDeleteEvent} 事件对象, 表示一个
     *              {@link User} 实体被删除
     */
    @Subscribe

...
import static alvin.study.infra.model.public_.tables.Employee.EMPLOYEE;
...
import alvin.study.infra.model.public_.tables.pojos.Department;
...
public class DepartmentRepository extends BaseRepository<DepartmentRecord> {
     ...
     *
     * <p>
     * 该方法演示了一个自连接查询, 通过 {@link id} 和 {@link parent_id} 字段形成部门的上下级关系
     * </p>
     *
     * @param name 要查询的部门名称

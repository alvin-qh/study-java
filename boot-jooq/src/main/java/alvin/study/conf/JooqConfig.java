...
import alvin.study.core.jooq.listener.AuditAndTentedRecordListener;
import alvin.study.core.jooq.listener.TentedVisitListener;
...
public class JooqConfig {
    // 注入 JOOQ 数据记录监听器
    @Autowired
    private AuditAndTentedRecordListener auditRecordListener;

    // 注入 JOOQ 数据访问监听器
    @Autowired
    private TentedVisitListener tentedVisitListener;
     ...
     *
     * @see #configuration(DataSourceConnectionProvider)
     */
    @Bean

package alvin.study.core.jooq.listener;
...
import alvin.study.infra.model.public_.tables.records.UserRecord;
...
public class AuditAndTentedRecordListener implements RecordListener, RecordListenerProvider {
    ...
    public void insertStart(RecordContext ctx) {
        ...
        for (var field : rec.fields()) {
            ...
            case "created_at" -> rec.setValue((Field<LocalDateTime>) field, LocalDateTime.now(ZoneOffset.UTC));

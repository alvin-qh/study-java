 ...
 * {@link alvin.study.infra.model.public_.tables.Org#ORG ORG} 表进行增删查改操作
 */
class OrgRepositoryTest extends IntegrationTest {
    ...
    /**
     * 测试通过
     * {@link alvin.study.core.jooq.dsl.JdbcDSLContextManager#tx(org.jooq.TransactionalRunnable)
     * JdbcDSLContextManager.tx(TransactionalRunnable)} 以及
     * {@link alvin.study.core.jooq.dsl.JdbcDSLContextManager#txr(org.jooq.TransactionalCallable)

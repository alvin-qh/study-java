...
public final class AnnotationUtil {
     ...
     *
     * @param <T>            注解类型
     * @param obj            包含被注解方法的对象
     * @param fieldName      被注解字段的名称
     * @param annotationType 注解类型
     * @return 所有符合条件的注解对象的集合
     */
    public static <T extends Annotation> List<T> getFieldAnnotation(Class<?> clazz,
            String fieldName,
     ...
     * @return 所有符合条件的注解对象的集合
     */
    public static <T extends Annotation> List<T> getMethodAnnotation(Class<?> clazz,
            String methodName,
            Class<T> annotationType) {
        // 遍历对象上的所有方法

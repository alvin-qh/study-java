...
import alvin.study.infra.model.Gender;
 ...
 * {@link alvin.study.infra.model.public_.tables.Employee#EMPLOYEE EMPLOYEE}
 * 表进行增删查改操作
 */
class EmployeeRepositoryTest extends IntegrationTest {
     ...
     * {@link alvin.study.infra.model.public_.tables.records.EmployeeRecord
     * EmployeeRecord} 持久化对象
     * </p>
     *
     * <p>
     * 通过
     * {@link alvin.study.infra.model.public_.tables.records.EmployeeRecord#store()
     ...
     * <p>
     * 通过
     * {@link alvin.study.infra.model.public_.tables.records.EmployeeRecord#update()
     ...
     * <p>
     * 通过
     * {@link alvin.study.infra.model.public_.tables.records.EmployeeRecord#delete()
    ...
    /**
     * 测试
     * {@link alvin.study.infra.model.public_.tables.records.EmployeeRecord#setInfo(EmployeeInfo)
     * EmployeeRecord.setInfo(EmployeeInfo)} 和
     * {@link alvin.study.infra.model.public_.tables.records.EmployeeRecord#getInfo()

...
import alvin.study.infra.model.public_.tables.records.EmployeeRecord;
...
import static alvin.study.infra.model.public_.tables.Department.DEPARTMENT;
import static org.assertj.core.api.BDDAssertions.then;

/**
 * 测试 {@link DepartmentRepository} 类型对
 * {@link alvin.study.infra.model.public_.tables.Department#DEPARTMENT
 * DEPARTMENT} 表进行增删查改操作
 */
class DepartmentRepositoryTest extends IntegrationTest {
     ...
     * <p>
     * 通过
     * {@link alvin.study.infra.repository.common.BaseRepository#newRecord(java.util.function.Consumer)
     * BaseRepository.newRecord(Consumer)} 方法产生一个
     * {@link alvin.study.infra.model.public_.tables.records.DepartmentRecord
     * DepartmentRecord} 持久化对象
     * </p>
     *
     * <p>
     * 通过
     * {@link alvin.study.infra.model.public_.tables.records.DepartmentRecord#store()
     ...
     * <p>
     * 通过
     * {@link alvin.study.infra.model.public_.tables.records.DepartmentRecord#update()
     ...
     * <p>
     * 通过
     * {@link alvin.study.infra.model.public_.tables.records.DepartmentRecord#delete()

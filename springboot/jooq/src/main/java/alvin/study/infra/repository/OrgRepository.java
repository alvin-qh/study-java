...
import static alvin.study.infra.model.public_.tables.Org.ORG;
...
import alvin.study.infra.model.public_.tables.records.OrgRecord;
import alvin.study.infra.repository.common.JdbcBaseRepository;

/**
 * 操作 {@link ORG} 表实体的 Repository 类型
 */
@Repository
public class OrgRepository extends JdbcBaseRepository<OrgRecord> {
     ...
     * {@link JdbcBaseRepository#newRecord()} 方法产生一个 Record 对象, 或者通过
     * {@link JdbcBaseRepository#newRecord(Object)} 方法将一个 Pojo 对象转化为 Record 对象
     * </li>
     * <li>
     ...
     * @throws SQLException
     */
    public OrgRecord insert(OrgRecord orgRecord) throws TooManyRowsException, DataAccessException, SQLException {
        // 执行一条 insert 语句
        return contextManager.get().insertInto(ORG)

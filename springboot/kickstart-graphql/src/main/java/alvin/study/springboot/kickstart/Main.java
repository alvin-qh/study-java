...
import alvin.study.springboot.kickstart.util.collection.Pair;
...
public class Main {
     ...
     */
    @SafeVarargs
    public static@NotNull Map<String, String> getDefaultProperties(Pair<String, String>... additionalProperties) {

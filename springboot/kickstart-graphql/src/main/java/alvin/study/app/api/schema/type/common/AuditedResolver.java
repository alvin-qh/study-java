...
import alvin.study.app.api.schema.loader.UserLoaderProvider;
 ...
 * {@link alvin.study.infra.entity.User User} 实体对象的 id 值
 * </p>
 *
 * <p>
 * 本类型增加了 {@code createdByUser} 和 {@code updateByUser} 两个字段, 在 id 字段的基础上,
 * 查询到对应的 {@link alvin.study.infra.entity.User User} 实体并转为 {@link UserType} 类型
 * </p>
 *
 * <p>
 ...
 * {@link alvin.study.conf.GraphqlConfig#buildDataLoaders()

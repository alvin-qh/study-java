...
import alvin.study.app.api.schema.loader.OrgLoaderProvider;
 ...
 * {@link alvin.study.infra.entity.Org Org} 实体对象的 id 值
 * </p>
 *
 * <p>
 * 本类型增加了 {@code org} 字段, 在 orgId 字段的基础上, 查询到对应的
 * {@link alvin.study.infra.entity.Org Org} 实体并转为 {@link OrgType} 类型
 * </p>
 *
 * <p>

...
import alvin.study.app.api.schema.input.UserInput;
...
/**
 * 测试 {@link alvin.study.app.api.query.UserQuery UserQuery} 和
 * {@link alvin.study.app.api.mutation.UserMutation UserMutation} 类型
 *
 * <p>
...
class UserTest extends IntegrationTest {
    /**
     * 测试 {@link alvin.study.app.api.query.UserQuery#user(String)
    ...
    /**
     * 测试 {@link alvin.study.app.api.mutation.UserMutation#createUser(UserInput)
    ...
    /**
     * 测试
     * {@link alvin.study.app.api.mutation.UserMutation#updateUser(String, UserInput)
    ...
    /**
     * 测试
     * {@link alvin.study.app.api.mutation.UserMutation#deleteUser(String)

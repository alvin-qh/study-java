...
import alvin.study.app.domain.service.SessionService;
import alvin.study.core.shiro.CustomerCredentialsMatcher;
import alvin.study.core.shiro.CustomerRealm;
import alvin.study.core.shiro.RedisCacheManager;
import alvin.study.core.shiro.RedisSessionDAO;
import alvin.study.core.shiro.RedisSessionManager;
import alvin.study.core.shiro.SessionUtil;
import alvin.study.core.shiro.TokenAuthenticationFilter;
...
public class ShiroConfig {
    ...
    ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager, ObjectMapper objectMapper) {
        ...
        filterFactoryBean.getFilters().putAll(Map.of(

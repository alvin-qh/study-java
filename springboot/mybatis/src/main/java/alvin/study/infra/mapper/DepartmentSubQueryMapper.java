...
public interface DepartmentSubQueryMapper extends BaseMapper<Department> {
    /**
     * 根据 id 查询部门实体以及该部门的上级部门实体
     *
     * <p>
     * 该方法演示了如何通过多次查询根据实体的 {@code parent_id} 字段查询对应的实体, 这种方式对于 1:1 关系适用, 但对于 1:n 关系,
     * 可能会引发多次额外的查询, 导致 n + 1 问题
     * </p>
     *
     * @param id 部门 id
     * @return 部门实体对象的 {@link Optional} 包装对象
     */
    Optional<Department> selectWithParentById(@Param("id") Long id);
}

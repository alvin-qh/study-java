package alvin.study.app.api.controller;
...
import alvin.study.app.api.model.ContextDto;
import alvin.study.core.context.Context;
import alvin.study.core.context.NoContextAttributeException;
 ...
 * {@link alvin.study.app.api.advice.ApiResponseAdvice ApiResponseAdvice} 类型处理后,
 * 包装为统一的类型返回到客户端
 * </p>
 *
 * <p>
 ...
 * <p>
 * 在该 Controller 方法执行前,
 * {@link alvin.study.app.api.interceptor.ApiHandlerInterceptor} 拦截器会被执行,
 * 处理请求上下文
 * </p>
 *
 * <p>
 * 测试调用: http://localhost:8080/api/context, 并在请求头中设置 {@code X-Consumer-Id} 属性
 * </p>
 */
@Slf4j
@RestController
    ...
    ContextDto get() {
        ...
        try {
            ...
            throw HttpClientErrorException.create(
                e.getMessage(), HttpStatus.BAD_REQUEST, "no_org_code", null, null, null);
        }
    }
}

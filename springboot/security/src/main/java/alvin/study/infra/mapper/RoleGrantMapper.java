...
import alvin.study.infra.entity.RoleGrant;
...
@Mapper
@CacheNamespace
public interface RoleGrantMapper extends BaseMapper<RoleGrant> {
    /**
     * 查询权限授予对象
     *
     * @param userOrGroupId 用户或组 id
     * @param type          授予类型 (用户或组)
     * @param roleId        授权的角色 id
     * @return 权限授予对象
     */
    @Select("""
        select id, user_or_group_id, type, role_id, created_at, updated_at, created_by, updated_by
        from role_grant

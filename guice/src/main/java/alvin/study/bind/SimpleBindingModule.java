...
public class SimpleBindingModule implements Module {
     ...
     * AnnotatedBindingBuilder.to(Class)} 方法表示将给定的类型绑定到另一个类型上, 返回一个
     * {@link com.google.inject.binder.ScopedBindingBuilder
     ...
     *
     * <p>
     * <code>binder.bind(BindDemo.class).to(BindDemoImpl.class)</code> 这段代码说明的是,
     * 当注入的 {@link BindDemo} 类型字段时, 实际会注入一个具体的 {@link BindDemoImpl} 目标对象
     * 类型对象
     * </p>
     */
    @Override

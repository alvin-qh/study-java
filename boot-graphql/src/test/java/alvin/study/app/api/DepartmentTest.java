...
import alvin.study.app.api.schema.input.DepartmentInput;
import alvin.study.builder.DepartmentBuilder;
import alvin.study.builder.DepartmentEmployeeBuilder;
import alvin.study.builder.EmployeeBuilder;
import alvin.study.core.graphql.relay.Cursors;
import alvin.study.infra.entity.Department;
import alvin.study.infra.entity.Employee;
import alvin.study.util.collection.PathMap;

/**
 * 测试 {@link alvin.study.app.api.query.DepartmentQuery DepartmentQuery} 和
 * {@link alvin.study.app.api.mutation.DepartmentMutation DepartmentMutation}
 * 类型
 *
 * <p>
...
class DepartmentTest extends IntegrationTest {
    /**
     * 测试 {@link alvin.study.app.api.query.DepartmentQuery#department(String)
    ...
    void department_shouldQueryById() throws IOException {
        ...
        graphql("test-department", "queryDepartment", vars)
                ...
                .matches(v -> Cursors.parseCursor(v.getByPath("children.edges[0].cursor")).equals(1), "children.edges[0].cursor")
                ...
                .matches(v -> Cursors.parseCursor(v.getByPath("children.pageInfo.startCursor")).equals(1), "children.pageInfo.startCursor")
                .matches(v -> Cursors.parseCursor(v.getByPath("children.pageInfo.endCursor")).equals(6), "children.pageInfo.endCursor")
                ...
                .matches(v -> Cursors.parseCursor(v.getByPath("employees.edges[0].cursor")).equals(2), "employees.edges[0].cursor")
                ...
                .matches(v -> Cursors.parseCursor(v.getByPath("employees.pageInfo.startCursor")).equals(2), "employees.pageInfo.startCursor")
                .matches(v -> Cursors.parseCursor(v.getByPath("employees.pageInfo.endCursor")).equals(7), "employees.pageInfo.endCursor");
        // @formatter:on
    }

    /**
     * 测试
     * {@link alvin.study.app.api.mutation.DepartmentMutation#createDepartment(DepartmentInput)
    ...
    /**
     * 测试
     * {@link alvin.study.app.api.mutation.DepartmentMutation#updateDepartment(String, DepartmentInput)
    ...
    /**
     * 测试
     * {@link alvin.study.app.api.mutation.DepartmentMutation#deleteDepartment(String)

...
import alvin.study.app.api.schema.input.OrgInput;
import alvin.study.builder.OrgBuilder;
import alvin.study.infra.entity.Org;
import alvin.study.util.collection.PathMap;

/**
 * 测试 {@link alvin.study.app.api.query.OrgQuery OrgQuery} 和
 * {@link alvin.study.app.api.mutation.OrgMutation OrgMutation}
 * 类型
 *
 * <p>
...
class OrgTest extends IntegrationTest {
    /**
     * 测试 {@link alvin.study.app.api.query.OrgQuery#org(String)
    ...
    /**
     * 测试 {@link alvin.study.app.api.mutation.OrgMutation#createOrg(OrgInput)
    ...
    /**
     * 测试
     * {@link alvin.study.app.api.mutation.OrgMutation#updateOrg(String, OrgInput)
    ...
    /**
     * 测试
     * {@link alvin.study.app.api.mutation.OrgMutation#deleteOrg(String)

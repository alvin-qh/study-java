...
import alvin.study.app.api.schema.loader.DepartmentLoaderProvider;
import alvin.study.app.api.schema.type.common.AuditedResolver;
import alvin.study.app.api.schema.type.common.TenantedResolver;
import alvin.study.app.service.DepartmentService;
import alvin.study.app.service.EmployeeService;
import alvin.study.core.graphql.annotation.Resolver;
import alvin.study.core.graphql.relay.Connection;
import alvin.study.core.graphql.relay.ConnectionBuilder;
import alvin.study.core.graphql.relay.Pagination;
...
public class DepartmentTypeResolver implements AuditedResolver<DepartmentType>, TenantedResolver<DepartmentType> {
     ...
     * @see alvin.study.core.graphql.relay.ConnectionBuilder
     */

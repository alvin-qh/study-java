...
import alvin.study.core.graphql.context.GraphQLContextResolver;
import alvin.study.core.graphql.dataloader.DataLoaderProvider;
import alvin.study.core.graphql.directive.LengthDirective;
import alvin.study.core.graphql.directive.UppercaseDirective;
 ...
 *
 * <p>
 * {@link SimpleInstrumentation} 超类提供了一组拦截器, 用于拦截 Graphql 执行过程中的各个阶段, 参考:
 * {@link SimpleInstrumentation#beginExecution(InstrumentationExecutionParameters)}
 * 等方法
 * </p>
 *
 * <p>
...
public class GraphqlConfig extends SimpleInstrumentation implements GraphQLServletContextBuilder {
    // 注入所有的 Dataloader 对象
     ...
     */
    private DataLoaderRegistry buildDataLoaders() {
     ...
     *
     * <p>
     * 由于 Kickstart 框架是基于 Graphql Spring Boot 框架, 而 {@link SimpleInstrumentation} 超类是

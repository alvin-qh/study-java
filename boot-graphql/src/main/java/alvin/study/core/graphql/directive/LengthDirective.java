package alvin.study.core.graphql.directive;
 ...
 *
 * <p>
 * 本类型在 {@link alvin.study.conf.GraphqlConfig#lengthDirective()
...
public class LengthDirective implements SchemaDirectiveWiring {
    ...
    private List<GraphQLError> apply(GraphQLDirectiveContainer it, DataFetchingEnvironment env, Object value) {
        ...
        var min = parseArgument(directive, DIRECTIVE_ARG_MIN).intValue();
        var max = parseArgument(directive, DIRECTIVE_ARG_MAX).intValue();
